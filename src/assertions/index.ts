import { PatternMismatchError } from '../errors/index.js'
import { matchesPatternWithSelectionValidation } from '../runtime/index.js'
import type { GuardedValue, PatternStructureArgument } from '../types/index.js'
